export const ASSUMPTION_GUIDANCE = {
  retPre: {
    ...
    benchmark: {
      body: "歷史尺度（僅供比較）：0050 成立以來含息年化報酬約 13.3%（截至 2026 年 1 月，元大以每年 250 個交易日換算）；往回 10 年含息累積報酬 446.26%（截至 2025 年 11 月），換算年化約 18.51%。其追蹤的 FTSE 臺灣50含息指數，單一年度報酬曾有 2022 年 −21.5% 與 2024 年 +49.0%。S&P 500 的 1928–2025 長期美元價格年化報酬為 6.8%，其中 1957 年正式發布前是回溯試算；截至 2026 年 6 月底，往回 10 年美元價格年化報酬為 13.58%，不含股息。0050 實際基金報酬另受費用與追蹤差異影響；兩者的市場、幣別、截止日與口徑不同，不能直接當成你的預期報酬。",
      sources: [
