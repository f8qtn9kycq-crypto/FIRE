    ...
    <div>
      ...
      {[
        ...
        <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 0", borderBottom: "1px solid #1E1C18" }}>
          <span style={{ fontSize: 16, color: "#9B9890", flex: 1, paddingRight: 10, lineHeight: 1.45 }}>{label}</span>
          <span style={{ fontSize: 17, fontWeight: 700, fontFamily: "monospace", color: color === "good" ? "#4CAF85" : color === "bad" ? "#C05050" : color === "warn" ? "#C8953A" : "#E8E4DC", lineHeight: 1.35 }}>
            {value}
          </span>
        </div>
      ))}
