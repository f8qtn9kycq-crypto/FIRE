...
export const FIRE_BEGINNER_FAQ_ZH_TW = [
  ...
  },
  {
    ...
    question: "蒙地卡羅模擬顯示的「情境比例」要怎麼看？",
    answer:
      "蒙地卡羅模擬會根據你設定的平均報酬率與波動，每一年隨機抽一個報酬，重複跑出很多種可能的退休路徑。情境比例代表在這些簡化路徑中，有多少比例的情況下，你的資產仍能存活到預設規劃年齡。它是檢查不確定性的指標，不是統計上的真實成功機率，也不代表零風險或保證結果。",
  },
  {
